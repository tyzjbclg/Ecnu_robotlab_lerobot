...
![image-20260202170509768](C:\Users\75186\AppData\Roaming\Typora\typora-user-images\image-20260202170509768.png)

此时拔掉从臂usb接口按下回车会输出从臂的com id

![image-20260202170609662](C:\Users\75186\AppData\Roaming\Typora\typora-user-images\image-20260202170609662.png)
...
![image-20260202170932976](C:\Users\75186\AppData\Roaming\Typora\typora-user-images\image-20260202170932976.png)
...
![image-20260202173305592](C:\Users\75186\AppData\Roaming\Typora\typora-user-images\image-20260202173305592.png)

然后修改lerobot-main\lerobot\common\robot_devices\robots的config.py文件中的第480和486行 还有257行和263行，改成自己的相机id，laptop为顶视相机，phone为夹爪相机

![image-20260202173531160](C:\Users\75186\AppData\Roaming\Typora\typora-user-images\image-20260202173531160.png)

然后修改lerobot-main\lerobot\common\robot_devices\cameras\opencv.py 的333行，将第333行代码注释掉之后再下面添加如下代码。
...
![image-20260203202614330](C:\Users\75186\AppData\Roaming\Typora\typora-user-images\image-20260203202614330.png)
...
![image-20260202171826669](C:\Users\75186\AppData\Roaming\Typora\typora-user-images\image-20260202171826669.png)

然后以此按照下图四个图依次手动摆好从臂的位置，摆好一个位置按一下回车

![image-20260202171720642](C:\Users\75186\AppData\Roaming\Typora\typora-user-images\image-20260202171720642.png)

![image-20260202172126507](C:\Users\75186\AppData\Roaming\Typora\typora-user-images\image-20260202172126507.png)

完成如下图，**注意：完成从臂的标注后会自动开始进行主臂的标注**

![image-20260202172014731](C:\Users\75186\AppData\Roaming\Typora\typora-user-images\image-20260202172014731.png)
...
![image-20260206135111076](C:\Users\75186\AppData\Roaming\Typora\typora-user-images\image-20260206135111076.png)

2.删除episodes_stats.jsonl和episodes.jsonl里的json对应的json文件

​		![image-20260206135333456](C:\Users\75186\AppData\Roaming\Typora\typora-user-images\image-20260206135333456.png)

3.修改info.json里的"total_episodes","total_frames",和splits里的"train"参数

![image-20260206135412391](C:\Users\75186\AppData\Roaming\Typora\typora-user-images\image-20260206135412391.png)
